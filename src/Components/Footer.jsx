...
function BrandMark() {
  return (
    <div className="inline-flex items-center gap-3">
      <div className="h-10 w-10 rounded-full bg-gradient-to-br from-emerald-400 to-green-600 shadow-lg shadow-emerald-500/20 border border-white/10" />
      <div className="leading-tight">
        <div className="text-sm font-extrabold tracking-tight text-slate-50">Thornview</div>
        <div className="text-xs font-semibold tracking-wide text-slate-300">Grocery</div>
      </div>
    </div>
  );
}
      ...
      <div className="relative  sm:px-6 lg:px-8 py-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
          ...
          <div className="lg:col-span-5">
            <Link to="/" aria-label="Thornview Grocery Home" className="inline-flex">
              <BrandMark />
            </Link>

            <p className="mt-4 text-sm leading-6 text-slate-300 max-w-lg">
              Fresh groceries delivered fast. Shop essentials, schedule delivery or pickup,
              and track your orders in one place.
            </p>
            ...
            <div className="mt-6 rounded-2xl border border-white/10 bg-white/5 p-4">
              ...
              <ul className="mt-3 space-y-2 text-sm">
                ...
                <li className="flex items-start gap-2">
                  ...
                  <a href="tel:+880-1XXX-XXXXXX" className="link link-hover text-slate-200">
                    +880 1XXX-XXXXXX
                  </a>
                </li>
          ...
          <div className="lg:col-span-7 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div>
              ...
              <div className="mt-4 text-xs text-slate-400">
                Admin links will work only for users with <span className="text-slate-200 font-semibold">admin/manager</span> role.
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="mt-10 pt-6 border-t border-white/10 flex flex-col lg:flex-row gap-4 lg:items-center lg:justify-between">
            ...
            <div className="rounded-2xl border border-white/10 bg-white/5 p-4">
              <div className="flex flex-col md:flex-row md:items-center gap-3 md:justify-between">
                <div className="min-w-0">
                  <div className="font-semibold text-slate-50">Get offers & updates</div>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between gap-3 w-full lg:w-auto">
            <p className="text-xs md:text-sm text-slate-300 text-center sm:text-left">
              ...
              <span className="font-semibold text-slate-100">Thornview Grocery</span>. All rights reserved.
            </p>
